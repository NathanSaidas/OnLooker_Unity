...
namespace Gem
{
    ...
    public class UIEditor : EditorWindow
    {
        ...
        public const string MAX_CHARACTER = "Max Character";
        ...
        #region DEBUG ONLY
        private const string MISSING_TEXTFIELD = "Missing UITextfield in child game object";
        ...
        private void CreateUIToggle()
        {
            ...
            switch(toggle.uiType)
            {
                ...
                case UIType.BUTTON:
                    ...
                    break;
                case UIType.TEXTFIELD:
                    UIUtilities.CreateUITextfield(m_ToggleParams as UITextfieldParams, toggle);
                    break;
            }
        ...
        private void DrawUITextfield()
        {
            UITextfieldParams textfieldParams = m_ToggleParams as UITextfieldParams;
            if (textfieldParams == null)
            {
                CreateParamsForType(m_ToggleParams.uiType);
                textfieldParams = m_ToggleParams as UITextfieldParams;
            }
            textfieldParams.disabled = EditorGUILayout.Toggle(DISABLED, textfieldParams.disabled);
            EditorGUILayout.LabelField(BUTTON + TEXTURE);
            textfieldParams.disabledTexture = EditorUtilities.textureField(DISABLED, textfieldParams.disabledTexture);
            textfieldParams.normalTexture = EditorUtilities.textureField(NORMAL, textfieldParams.normalTexture);
            textfieldParams.hoverTexture = EditorUtilities.textureField(HOVER, textfieldParams.hoverTexture);
            textfieldParams.downTexture = EditorUtilities.textureField(DOWN, textfieldParams.downTexture);
            textfieldParams.enabledTextColor = EditorGUILayout.ColorField(ENABLED_TEXT_COLOR, textfieldParams.enabledTextColor);
            textfieldParams.disabledTextColor = EditorGUILayout.ColorField(DISABLED_TEXT_COLOR, textfieldParams.disabledTextColor);
            textfieldParams.eventListener = EditorUtilities.ObjectField<UIEventListener>(UI_EVENT_LISTENER, textfieldParams.eventListener);
            textfieldParams.maxCharacter = EditorGUILayout.IntField(MAX_CHARACTER, textfieldParams.maxCharacter);

            textfieldParams.labelText = EditorGUILayout.TextField(TEXT, textfieldParams.labelText);
            textfieldParams.labelFontSize = EditorGUILayout.IntField(FONT_SIZE, textfieldParams.labelFontSize);
            textfieldParams.labelFont = EditorUtilities.fontField(FONT, textfieldParams.labelFont);
            textfieldParams.labelColor = EditorGUILayout.ColorField(COLOR, textfieldParams.labelColor);
            textfieldParams.labelFontTexture = EditorUtilities.textureField(TEXTURE, textfieldParams.labelFontTexture);

            EditorGUILayout.BeginHorizontal();
            textfieldParams.imageWidth = EditorGUILayout.FloatField(WIDTH, textfieldParams.imageWidth);
            textfieldParams.imageHeight = EditorGUILayout.FloatField(HEIGHT, textfieldParams.imageHeight);
            EditorGUILayout.EndHorizontal();
            textfieldParams.imageMeshBoarder = EditorUtilities.UIBoarderField(MESH_BOARDER, textfieldParams.imageMeshBoarder);
            textfieldParams.imageOuterUVBoarder = EditorUtilities.UIBoarderField(OUTER_UV_BOARDER, textfieldParams.imageOuterUVBoarder);
            textfieldParams.imageInnerUVBoarder = EditorUtilities.UIBoarderField(INNER_UV_BOARDER, textfieldParams.imageInnerUVBoarder);
            textfieldParams.imageTexture = EditorUtilities.ObjectField<Texture>(TEXTURE, textfieldParams.imageTexture);
            textfieldParams.imageShader = EditorUtilities.ObjectField<Shader>(SHADER, textfieldParams.imageShader);
            textfieldParams.imageColor = EditorGUILayout.ColorField(COLOR, textfieldParams.imageColor);
