...
namespace EndevGame
{
    ...
    public class CameraManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// This helper method returns true if the target given was the current cameras target.
        /// </summary>
        /// <param name="aTarget">The target to compare with</param>
        /// <returns></returns>
        private bool cameraIsTarget(Transform aTarget)
        {
            if (aTarget == null)
                return false;
            ...
            {
                case State.ORBIT:
                    return m_OrbitCamera.target == aTarget;
                case State.SHOULDER:
                    return m_ShoulderCamera.target == aTarget;
                case State.FIRST_PERSON:
                    return m_FirstPersonCamera.target == aTarget;
                default:
                    return false;
            }
        }
        public static bool cameraIsMine(Transform aTarget)
        {
            if(instance == null)
            {
                Debug.LogError("Missing \'Camera Manager\' please create one or start from the \'init_scene\'");
                return false;
            }
            return instance.cameraIsTarget(aTarget);
        }
        #endregion
        ...
        public static Camera gameplayCamera
        {
            get
            {
                if (instance == null)
                {
                    Debug.LogWarning("Missing \'CameraManager\' from the scene. Add one or start from the \'init_scene\'.");
                    return null;
                }
                return instance.m_GameplayCamera;
            }
            set
            {
                if (instance == null)
                ...
                instance.m_GameplayCamera = value;
            }
        }
        public static FirstPersonCamera firstPersonCamera
        {
            get
            {
                if (instance == null)
                ...
                return instance.m_FirstPersonCamera;
            }
            set
            {
                if (instance == null)
                ...
                instance.m_FirstPersonCamera = value;
            }
        }
        public static ShoulderCamera shoulderCamera
        {
            get
            {
                if (instance == null)
                ...
                return instance.m_ShoulderCamera;
            }
            set
            {
                if (instance == null)
                ...
                instance.m_ShoulderCamera = value;
            }
        }
