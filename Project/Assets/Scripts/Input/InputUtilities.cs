...
namespace EndevGame
{
    ...
    public static class InputUtilities
    {
        ...
        /// <summary>
        /// This method returns true where the given arguments are a valid inputString.
        /// </summary>
        /// <param name="aInputString">The string to process.</param>
        /// <param name="aDeviceType">The target deviceType</param>
        /// <returns></returns>
        public static bool parseInputString(string aInputString, InputDevice aDeviceType)
        {
            //TODO: Implement similar logic as the function down below. Returning true where conditions are met.
            switch(aDeviceType)
            {
