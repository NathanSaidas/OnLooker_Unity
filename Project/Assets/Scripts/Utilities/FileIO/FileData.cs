...
namespace OnLooker
{
        ...
        public class FileData
        {
            ...
            /// <summary>
            /// Can get data off the end of the list where types match.
            /// </summary>
            ...
            /// <summary>
            /// Adds an entire array data into the file data 
            /// </summary>
            /// <param name="aData"></param>
            public void add(SaveData[] aData)
            {
            ...
            public void save()
            {
                ...
                FileStream stream = File.Open(m_FileHeader.filename, FileMode.Create, FileAccess.Write);
            ...
            public void load()
            {
                ...
                BinaryFormatter formatter = new BinaryFormatter();
                FileStream stream = File.Open(m_FileHeader.filename, FileMode.Open, FileAccess.Read);
                try
                {
            ...
            /// </summary>
            /// <param name="aName"></param>
            public void rename(string aName, bool aRenameOnHDD)
            {
                aName = getPath(aName);
                if (aRenameOnHDD == true)
                {
            ...
            {
#if UNITY_IPHONE
                return Application.dataPath + "/Raw/" + aFile + ".GD";
#elif UNITY_ANDROID
                return "jar:file://" + Application.dataPath + "!/assets/ + aFile + ".GD";
#else
                return Application.dataPath + "/StreamingAssets/" + aFile + ".GD";
#endif
            }
        }
}
